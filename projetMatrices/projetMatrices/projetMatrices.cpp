...
void main()
{
	try
	{
		...
		*MATIntMatrice4 = *MATIntMatrice4 - *MATIntMatrice3 / 2;
		...
		/*
		cout<<"Matrice 1 (Setteur par la transposée de la matrice 3):\n";
		MATIntMatrice1->MATsetMatrice(MATIntMatrice3->MTMATTransposeeMatrice(), MATIntMatrice3->MATgetNbColonnes, MATIntMatrice3->MATgetNbLignes); */
